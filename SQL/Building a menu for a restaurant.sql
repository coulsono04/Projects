...
--  This project aims to assess skills in creating a complex table for a specific business myself, 
--  then querying and searching through the database.
...
categories_dishes.price, category.name AS category
