...
namespace MadLibs
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // This project was done to test skills using strings, to create a mad libs game where the user can input their own words that fit into the pre established story.
